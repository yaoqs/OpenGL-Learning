...
{
	if(m_Position.x > MAP_WIDTH - 20 )
		m_Position.x = MAP_WIDTH - 20 ;
		
	if(m_Position.x < CELL_WIDTH )
	   m_Position.x = CELL_WIDTH ;

	if(m_Position.z > MAP_WIDTH - 20)
		m_Position.z = MAP_WIDTH - 20;
	
	if(m_Position.z < CELL_WIDTH )
		m_Position.z = CELL_WIDTH ;
