...
begin
  ...
  if MessageBox(0,'ÊÇ·ñÏëÒÔÈ«ÆÁÄ£Ê½ÏÔÊ¾Í¼ÐÎ£¿','ÊÇ·ñÈ«ÆÁ',
                             MB_YESNO or MB_ICONQUESTION)=IDNO then
    FullScreen:=false                                 // Bìh v oknì
  else
    FullScreen:=true;                                 // Fullscreen
  if not CreateGLWindow('Delphi¿ª·¢OpenGLÓ¦ÓÃ³ÌÐò¿ò¼Ü',640,480,16,FullScreen) then // Vytvoøení OpenGL okna
    begin
      ...
      if (PeekMessage(msg, 0, 0, 0, PM_REMOVE)) then  // Pøišla zpráva?
        ...
        begin
          ...
          if keys[VK_F1] then                         // Byla stisknuta klávesa F1?
            ...
            // Znovuvytvoøení okna
            if not CreateGLWindow('Delphi¿ª·¢OpenGLÓ¦ÓÃ³ÌÐò¿ò¼Ü',640,480,16,fullscreen) then
