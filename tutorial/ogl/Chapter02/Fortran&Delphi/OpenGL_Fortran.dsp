...
!MESSAGE 
!MESSAGE NMAKE /f "OpenGL_Fortran.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "OpenGL_Fortran.mak" CFG="Lesson05 - Win32 Debug"
!MESSAGE 
...
SOURCE=.\GL_Display.f90
DEP_F90_GL_DI=\
	".\Debug\Windows.mod"\
	{$(INCLUDE)}"Opengl_GL.mod"\
	{$(INCLUDE)}"Opengl_GLAUX.mod"\
	{$(INCLUDE)}"Opengl_GLU.mod"\
	{$(INCLUDE)}"Opengl_WGL.mod"\
