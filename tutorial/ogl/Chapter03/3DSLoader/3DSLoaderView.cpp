...
void CMy3DSLoaderView::DrawData()
{
	//glPointSize(1.5f);
	...
	{
		double x=-sin(i*3.1416/180.0)*800.0;
		double y=cos(i*3.1416/180.0)*800.0;
		double z=0.0;
		glVertex3f(x,y,z);
	}
...
void CMy3DSLoaderView::Draw3ds()
{
	...
	if (m_3dsLoaded) 
	{
		glTranslatef(-sin(rotate*3.1416/180.0)*800.0,cos(rotate*3.1416/180.0)*800.0,0.0);
...
void CMy3DSLoaderView::OnLButtonDblClk(UINT nFlags, CPoint point) 
{
	// TODO: Add your message handler code here and/or call default
...
void CMy3DSLoaderView::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags) 
{
	...
	switch(nChar)
	{
	case 37:camPos[0]-=25.0f;break;
	case 38:camPos[1]+=25.0f;break;
	case 39:camPos[0]+=25.0f;break;
	case 40:camPos[1]-=25.0f;break;
	}
