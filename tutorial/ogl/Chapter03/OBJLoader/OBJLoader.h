// OBJLoader.h : main header file for the OBJLOADER application
//
...
/////////////////////////////////////////////////////////////////////////////
// COBJLoaderApp:
// See OBJLoader.cpp for the implementation of this class
//

class COBJLoaderApp : public CWinApp
{
public:
	COBJLoaderApp();
...
// Overrides
	...
	//{{AFX_VIRTUAL(COBJLoaderApp)
	public:
	virtual BOOL InitInstance();
	//}}AFX_VIRTUAL

// Implementation
	//{{AFX_MSG(COBJLoaderApp)
