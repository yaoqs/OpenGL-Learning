// AseReader.cpp: implementation of the CAseReader class.
//
//////////////////////////////////////////////////////////////////////
...
bool CAseReader::ImportASE(t3DModel *pModel, char *strFileName)
{
...
void CAseReader::ReadAseFile(t3DModel *pModel)
{
...
int CAseReader::GetMaterialCount()
{
	char strWord[255] = {0};
	int materialCount = 0;
...
void CAseReader::GetTextureInfo (tMaterialInfo *pTexture, int desiredMaterial)
{
	char strWord[255] = {0};
	int materialCount= 0;
...
void CAseReader::MoveToObject (int desiredObject)
{
	char strWord[255] = {0};
	int objectCount = 0;
...
void CAseReader::ReadObjectInfo(t3DObject *pObject, int desiredObject)
{
	char strWord[255] = {0};
...
void CAseReader::GetTextureName(tMaterialInfo *pTexture)
{
...
void CAseReader::GetMaterialName(tMaterialInfo *pTexture)
{
...
void CAseReader::ReadObjectData(t3DModel *pModel, t3DObject *pObject, int desiredObject)
{
...
void CAseReader::GetData(t3DModel *pModel, t3DObject *pObject, char *strDesiredData, int desiredObject)
{
	char strWord[255] = {0};
...
void CAseReader::ReadVertex(t3DObject *pObject)
{
	int index = 0;
...
void CAseReader::ReadTextureVertex(t3DObject *pObject, tMaterialInfo texture)
{
	int index = 0;
...
void CAseReader::ReadFace(t3DObject *pObject)
{
	int index = 0;
...
void CAseReader::ReadTextureFace(t3DObject *pObject)
{
	int index = 0;
...
void CAseReader::ComputeNormals(t3DModel *pModel)
{
