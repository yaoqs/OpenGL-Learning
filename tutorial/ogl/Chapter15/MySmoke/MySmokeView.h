// MySmokeView.h : interface of the CMySmokeView class
//
/////////////////////////////////////////////////////////////////////////////
...
class CMySmokeView : public CView
{
protected: // create from serialization only
	CMySmokeView();
	DECLARE_DYNCREATE(CMySmokeView)

// Attributes
public:
	CMySmokeDoc* GetDocument();
...
/////////////////////////////////////////////////////////////////
	...
	void exploder(float x, float y, float z, float size, float intensity, float opacity, float delay, float scale);
	void explode(void);
	void Init(GLvoid);
...
#ifndef _DEBUG  // debug version in MySmokeView.cpp
inline CMySmokeDoc* CMySmokeView::GetDocument()
