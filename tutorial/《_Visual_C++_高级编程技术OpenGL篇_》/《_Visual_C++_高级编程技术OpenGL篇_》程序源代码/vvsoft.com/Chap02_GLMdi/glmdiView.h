...
class CGlmdiView : public CView
{
protected:
	CGlmdiView();// protected constructor used by dynamic creation
	DECLARE_DYNCREATE(CGlmdiView)
/** CGLDispList
